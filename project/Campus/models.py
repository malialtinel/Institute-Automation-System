...
class Program(models.Model):
    ...
    quota_manager = models.ForeignKey('AcademicStaff', models.SET_NULL, blank=True, null=True)
    # quota manager fk quota manager olacak
    class Meta:
...
class Section(models.Model):
    ...
    quota = models.PositiveIntegerField('Quota Quantity', validators=[MaxValueValidator(50)], null=True)
...
class Schedule(models.Model):
    section = models.ForeignKey('Section', verbose_name='Section', max_length=10, on_delete=models.CASCADE, null=True)
    ...
    def __str__(self):
        return '(' + str(self.section) + ') ' + str(self.day) + str(self.slot) + ' / ' + str(self.place)
